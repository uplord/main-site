      ...
      <div className={styles.container}>
        ...
        <div className={styles.grid}>
          <div className={clsx(styles.item, styles['item-2'])}>
            <div className={styles.image} style={{ backgroundColor: '#008fbe'}}>
              <Image
            ...
            <div className={styles.text}>
              <h3>Brewdog Now</h3>
              <p>BrewDog Now is BrewDog’s rapid beer delivery and ordering service, designed to bring fresh craft beer and food directly to your door or table.</p>
            </div>
          </div>
          <div className={clsx(styles.item, styles['item-3'])}>
            <div className={styles.image} style={{ backgroundColor: '#ff7a00'}}>
              <Image
                src="/images/gdk.svg"
                alt="GDK"
                width={166}
          ...
          <div className={clsx(styles.item, styles['item-3'])}>
            <div className={styles.image} style={{ backgroundColor: '#ff2d55'}}>
              <Image
            ...
            <div className={styles.text}>
              <h3>Leaselcoo</h3>
              <p>LeaseLoco is the UK’s leading car lease comparison site, making it easy to find and compare top deals with real-time pricing and value scores.</p>
            </div>
          </div>
          <div className={clsx(styles.item, styles['item-2'])}>
            <div className={styles.image} style={{ backgroundColor: '#0F554A'}}>
              <Image
          ...
          <div className={clsx(styles.item, styles['item-2'])}>
            <div className={styles.image} style={{ backgroundColor: '#14569e'}}>
              <Image
          ...
          <div className={clsx(styles.item, styles['item-3'])}>
            <div className={styles.image} style={{ backgroundColor: '#F33E3E'}}>
              <Image
